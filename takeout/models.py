...
class Shop(models.Model):
    ...
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, null=True,on_delete=True)
...
class Ident(models.Model):
    ...
    deliveryman_id = models.ForeignKey(DeliveryMan, null=True,on_delete=True)
...
class Food(models.Model):
    ...
    shop_id = models.ForeignKey(Shop, null=True,on_delete=True)


class Ident_Food(models.Model):
    ident_id = models.ForeignKey(Ident,on_delete=True)
    food_id = models.ForeignKey(Food,on_delete=True)
...
class Cart(models.Model):
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=True)
    food_id = models.ForeignKey(Food,on_delete=True)
    food_num = models.IntegerField(null=True)
